...
function travel_blog_posted_on() {
	...
	$posted_on = sprintf(
		esc_html_x( '%s', 'post date', 'travel-blog' ),
...
function travel_blog_entry_footer() {
	...
	if ( ! is_single() && ! post_password_required() && ( comments_open() || get_comments_number() ) ) {
		...
		comments_popup_link( sprintf( wp_kses( __( 'Leave a Comment<span class="screen-reader-text"> on %s</span>', 'travel-blog' ), array( 'span' => array( 'class' => array() ) ) ), get_the_title() ) );
		echo '</span>';
	}
